      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-5">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-10">
            ...
            <motion.a
              ...
              className="px-5 py-2 rounded-full bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-500 hover:to-cyan-500 text-white text-sm font-semibold transition-all shadow-lg shadow-blue-500/20"
            >
              Hire Me
            </motion.a>
          </div>
        ...
        <AnimatePresence>
          {isOpen && (
            ...
            >
              <div className="mt-5 pb-5 space-y-4 border-t border-white/5 pt-5">
                ...
                <a
                  href="#contact"
                  className="block w-full text-center px-5 py-2.5 rounded-full bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-semibold"
                  onClick={() => setIsOpen(false)}
                >
                  Hire Me
                </a>
