...
export default function Footer() {
  return (
    <footer className="border-t py-10 px-6 relative" style={{ background: "#030712", borderColor: "rgba(255,255,255,0.05)" }}>
      <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <p className="text-xs font-mono text-white/25">© 2026 Wilfried LAWSON HELLU</p>
        </div>
